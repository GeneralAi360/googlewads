...
class CopyAdaptationTests(unittest.TestCase):
            ...
            "banner_matrix": [
                {
                    ...
                    "output_path": (root / "out" / "rectangle.png").as_posix(),
                    "output_format": "png",
                },
                {
                    "job_id": "C01-S320x50-V01-Lru",
                    "concept_id": "C01",
                    "variant_id": "V01",
                    "language": "ru",
                    "width": 320,
                    "height": 50,
                    "dimension": "320x50",
                    "layout_family": "micro_horizontal",
                    "output_path": (root / "out" / "micro.png").as_posix(),
                    "output_format": "png",
                },
            ],
        }
    ...
    def contract(self):
        return {
            ...
            "supporting_proof": "Verified proof",
            ...
            "variants": [
                {
                    ...
                    "copy_by_language": {
                        "ru": {
                            "headline": "Полный заголовок",
                            "support": "Поддерживающий текст",
                            "offer": "DEMO OFFER",
                            "cta": "Рассчитать",
                        }
                    },
                    "copy_overrides_by_layout_family": {
                        "micro_horizontal": {"headline": "Короткий заголовок", "support": None, "offer": None}
                    },
                    "copy_overrides_by_dimension": {
                        "320x50": {"headline": "320 заголовок"}
                    },
                }
            ],
        }
